...
// +2 functions / +2 methods.
constexpr std::size_t kExpectedFunctionCount = 2266;
constexpr std::size_t kExpectedClassCount = 131;
constexpr std::size_t kExpectedPropertyCount = 829;
constexpr std::size_t kExpectedMethodCount = 1222;
...
int main() {
    ...
    constexpr std::uint64_t kExpectedManifestHash = UINT64_C(0x96d4bb5a8a2f756a); /* ADR 0300: AnimController3D.CrossfadeAt */
