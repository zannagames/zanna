...
std::vector<CompletionItem> BasicCompletionEngine::provideBuiltins(
    ...
    static const struct {
        ...
        {"LEN", "LEN(s$) -> INTEGER"},
        {"LOC", "LOC(#channel) -> INTEGER"},
        {"LOF", "LOF(#channel) -> INTEGER"},
        {"LOG", "LOG(n) -> DOUBLE"},
        ...
        {"SQR", "SQR(n) -> DOUBLE"},
        {"STR$", "STR$(n) -> STRING"},
        {"STRING$", "STRING$(n, code or s$) -> STRING"},
        {"TAN", "TAN(n) -> DOUBLE"},
        {"TIMER", "TIMER() -> INTEGER (milliseconds)"},
        {"TRIM$", "TRIM$(s$) -> STRING"},
