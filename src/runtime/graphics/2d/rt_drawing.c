...
/* UTF-8 decoding and built-in font text measurement (rt_canvas_next_codepoint,
 * rt_canvas_text_bytes, rt_canvas_text_codepoint_width) live in rt_graphics_internal.h
 * so graphics-disabled builds measure text identically. */
...
/* Color constants and Color.RGB/RGBA live in rt_color.c, which also compiles into
