...
- [Defect Audit (2026-09-01)](../defect-audit-2026-09-01.md) — 30 engine defects found while validating the documentation tree against the running toolchain, each with a minimal reproduction
